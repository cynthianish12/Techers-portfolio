    ...
    return (
        <div className="flex m-[4rem] space-x-[10rem] ">
            <div className="max-w-[800px] space-y-[2rem] ">
                ...
                <></>
                <p>Our approach is centered on collaboration, transparency, and continuous improvement. We work closely with our clients to understand their goals and objectives, leveraging our technical expertise and industry insights to deliver solutions that align with their strategic vision. Whether you're a startup looking to launch a new product or an established enterprise seeking to modernize your systems, we're here to help you succeed. At TechVision, we're not just building software – we're building partnerships that last.</p>
            </div>
